...
>>>>>>> 1a5464c9044f3bcf2c62cd76e6f411e77a613a20
    ...
    constructor(http, eventService, route, router, entityService) {
        ...
        this.eventService.eventEvent$.subscribe(ev => {
            ...
            if ((ev instanceof src_app_services_events_service__WEBPACK_IMPORTED_MODULE_0__["StepFile"]) && !(ev instanceof src_app_services_events_service__WEBPACK_IMPORTED_MODULE_0__["StepFileSaved"])) {
                ...
                setTimeout(() => {
                    this.selectedTabIndex = 4 + this.openFiles.indexOf(found || new src_app_services_events_service__WEBPACK_IMPORTED_MODULE_0__["StepFile"]("", ""));
